...
const Page1 = () => {
  ...
  <div className="row w-100">
    <div className="col-lg-5 col-md-6 col-xs-12 col-xl-5  mt-5 classpage1cssmobile">
      
    <h1 className='mt-5'>Accelerate your </h1>
             <h1 className='colorh6 fw-bold'>Business growth<span style={{color:'black'}}> With </span>  SOCIAL MEDIA MARKETING</h1>
    ...
    <div class="col-lg-5 col-md-6 col-xs-12 col-sm-12 col-xl-5 ">
      <div className='mt-3 w-100 bg-white rounded-5'>
          ...
          <button type='button' className='btn custom-button1 mb-3 rounded-5'  style={{backgroundColor:'rgb(255, 110, 20)',color:'white'}}>Book a Call  <ArrowCircleRightIcon style={{width:'2rem',height:'2rem'}}/></button>
