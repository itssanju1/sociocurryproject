...
<div className='classfootercol14512 '>
  <button className='btn mt-3 classfootercol14512 fs-4' style={{ textAlign:'left',backgroundColor:'white',width:'70%'}}><CallIcon style={{width:'2.5rem',height:'2.5rem'}}/> +91 9818777620</button>
   ...
   <div className='classfootercol1451245 '>
<button className='btn mt-3 classfootercol145121 fs-4' style={{ textAlign:'left',backgroundColor:'white'}}><MapsUgcSharpIcon style={{width:'2.5rem',height:'2.5rem'}}/> Chat with Us</button>
</div>
