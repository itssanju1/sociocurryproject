  ...
  return (
    <>
      ...
      <Carousel>
        <CarouselItem>
        <div className='row'>
          <div className='col-xl-3 col-lg-3 col-xs-2 col-sm-1 col-md-3'>
      ...
      <div className='container'>
        <div className='row mt-5'>
          <div className='col-xl-5 col-xs-12 col-sm-12 col-md-5 col-lg-5 mt-5'>
           <h1 className='fw-bold text-center' ><span style={{color:'rgb(255, 110, 20)'}}>Goals</span> we help you achieve </h1>
           <h1 className='fw-bold text-center'>with our <span style={{color:'rgb(255, 110, 20)'}}>Expert Guidance</span> </h1>
           
          </div>
          <div className='col-2'></div>
          <div className='col-xl-5 col-xs-12 col-sm-12 col-md-5 col-lg-5 mt-5'>
            <h5 className='text-left mb-4 texth5page7css'>Is your brand rocking the social scene but lacking in conversions and sales? Or are you hungry for more likes and shares? Fear not, we've got the magic touch to turn things around!</h5>
